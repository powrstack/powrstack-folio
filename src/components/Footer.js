  ...
  return (
    <footer className="footer footer-center bg-base-200 text-base-content">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="footer footer-center bg-base-200 text-base-content border-base-300 border-t px-10 py-4">
          <aside className="flex flex-col sm:flex-row items-center justify-between w-full">
            <p className="text-sm">
              © {currentYear} {personalInfo?.name || 'Developer Portfolio'}. All rights reserved.
            </p>
            <div className="flex items-center space-x-4 mt-2 sm:mt-0">
              <p className="text-xs opacity-70">
                Built with ❤️ using Next.js & DaisyUI
              </p>
