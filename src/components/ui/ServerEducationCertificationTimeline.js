...
import ServerEducationTimelineItem from './ServerEducationTimelineItem';

const ServerEducationCertificationTimeline = memo(function ServerEducationCertificationTimeline({ resumeData }) {
...
export default ServerEducationCertificationTimeline;
